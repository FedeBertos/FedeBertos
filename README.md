...
### 👋 Hi there! I'm a student & tech enthusiast
I am currently strictly focused on **Computer Science**, balancing academic coursework with a strong passion for **Home Lab** infrastructure and **Linux** systems.

---

### 💻 Core Programming & Academic Focus
...
[![Cisco](https://img.shields.io/badge/Cisco-1BA0D7?style=for-the-badge&logo=cisco&logoColor=white)](https://www.netacad.com/courses/packet-tracer)
...
* **Workflow:** Daily use of Git/GitHub for code synchronization.
* **Documentation:** Experience with Markdown and Huffman trees visualization using Mermaid.js.
* **Design:** Experience with vector (Inkscape) and raster (Gimp) graphics editing.
